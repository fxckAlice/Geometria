...
"Geometria" is a program to resources.resources.figures.triangle.help to calculate basic parameters in simple resources.figures :ballot_box_with_check:
...
3. ```public double pythagoreanTheorem(double a, double b, char action)``` - this is a function that implements the Pythagorean theorem to calculate the length of the hypotenuse of a resources.resources.figures.triangle or the difference of the legs depending on the specified operation.
  + ```Variables```:
    + ```double a``` - length of the first leg of the resources.resources.figures.triangle;
    + ```double b``` - length of the second leg of the resources.resources.figures.triangle;
...
### The package `resources.resources.figures.triangle.rectangle`:
#### The 2D resources.figures:
...
- ```double length``` - the main values that denotes the value of resources.resources.figures.triangle.rectangle`s side;
...
- ```area()``` - method which calculates the area of resources.resources.figures.triangle.rectangle using ```double length``` and ```double width```;
- ```perimeter()``` - method which calculates the perimeter of resources.resources.figures.triangle.rectangle using ```double length``` and ```double width```;
- ```diagonal()``` - method which calculates the diagonal of resources.resources.figures.triangle.rectangle using ```double length``` and ```double width```;
- ```outRadius()``` - method which calculates the radius of out resources.resources.figures.triangle.circle using ```double diagonal``` only if the resources.resources.figures.triangle.rectangle corresponds to the conditions for the existence of such a resources.resources.figures.triangle.circle;
- ```inputRadius()``` - method which calculates the radius of input resources.resources.figures.triangle.circle using ```double length``` only if the resources.resources.figures.triangle.rectangle corresponds to the conditions for the existence of such a resources.resources.figures.triangle.circle;
- ```corner()``` - method which calculates the corner of resources.resources.figures.triangle.rectangle;
- ```sumOfCorners()``` - method which calculates the sum of all corners in resources.resources.figures.triangle.rectangle; 
...
- ```double side(String parameter)``` - method which calculates the ```double width``` using ```double length``` and characteristic in dependence of parameter:
  - ```"a"``` - is the area of resources.resources.figures.triangle.rectangle;
  - ```"p"``` - is the perimeter of resources.resources.figures.triangle.rectangle;
  - ```"d"``` - is the diagonal of resources.resources.figures.triangle.rectangle;
  - ```"i"``` - is the radius of input resources.resources.figures.triangle.circle of resources.resources.figures.triangle.rectangle;
  - ```"o"``` - is the radius of out resources.resources.figures.triangle.circle of resources.resources.figures.triangle.rectangle.
...
+ ```diagonal()``` -  since a parallelogram is a derivative of a resources.resources.figures.triangle.rectangle and if you enter a diagonal, it doesn't work. It means you need to use `diagonal1()` or `diagonal2()` using ```double leinght```,```double width``` and `double corner`;

+ ```outRadius()``` - a resources.resources.figures.triangle.circle can be described around a square and a resources.resources.figures.triangle.rectangle, that is, when equality `diagonal1() == diagonal2()` is fulfilled.The method using method `diagonal1()`;
+ ```inputRadius()``` - method, which using `double length`, `double width` and `area()`, works only when `double length == double width` otherwise, it is not possible to inscribe a resources.resources.figures.triangle.circle in a parallelogram and find the radius;
...
### The package `resources.resources.figures.triangle`:
#### The 2D resources.figures:
...
+ ```perimeter()``` -  method which calculates the perimeter of equilateral resources.resources.figures.triangle using `double a`;
+ ```area()``` -  method which calculates the area of equilateral resources.resources.figures.triangle using ```double a```;
+ ```height()``` - method which calculates the height of equilateral resources.resources.figures.triangle using ```double a```;
+ ```outRadius()``` - method which calculates the radius of the resources.resources.figures.triangle.circle of equilateral resources.resources.figures.triangle using ```double a```;
+ ```inputRadius()``` - method which calculates the radius of the inscribed resources.resources.figures.triangle.circle of equilateral resources.resources.figures.triangle using ```double a```;
...
+ ```medianB()``` - method which calculates the median of isosceles resources.resources.figures.triangle using `double b` and `double a`;
+ ```heightB()``` - method which calculates the height of isosceles resources.resources.figures.triangle using `double b`;
+ ```double area(String parameter)``` - method which calculates the area of isosceles resources.resources.figures.triangle using characteristic in dependence of parameter:
...
+ ```medianA(), medianC()``` - method which calculates the median of resources.resources.figures.triangle using `double b`, `double c` and `double a`;
+ ```heightA()``` - method which calculates the height of resources.resources.figures.triangle using `double c` and `double cornerB`;
+ ```heightB()``` - method which calculates the height of resources.resources.figures.triangle using `double a` and `double cornerC`; 
+ ```heightC()``` - method which calculates the height of resources.resources.figures.triangle using `double b` and `double cornerA`;
...
+ ```setCornerC()``` - You should to input only 90 degrees, because it is a constant in right resources.resources.figures.triangle;
+ ```double area(String parameter)``` - method which calculates the area of right resources.resources.figures.triangle using characteristic in dependence of parameter:
  + ```"s"``` - using the `double a`, `double b`;
  + ```"c"``` - using the `double heightC`, `double c`. 

  If you enter another parameter, an error will occur.
+ ```double side(String parameter)``` - method which calculates the `double a` of right resources.resources.figures.triangle using characteristic in dependence of parameter:
  ...
  If you enter another parameter, an error will occur.
+ ```double sideB(String parameter)``` - method which calculates the `double a` of right resources.resources.figures.triangle using characteristic in dependence of parameter:
  ...
  If you enter another parameter, an error will occur.
+ ```double sideC(String parameter)``` - method which calculates the `double a` of right resources.resources.figures.triangle using characteristic in dependence of parameter:
...
---
### The package `resources.resources.figures.triangle.circle`:
#### The 2D resources.figures:
...
+ ```diameter()``` - method which calculates the diameter of resources.resources.figures.triangle.circle using `double radius`;
+ ```length()``` - method which calculates the length of resources.resources.figures.triangle.circle using `double radius`;
+ ```area()``` - method which calculates the area of resources.resources.figures.triangle.circle using `double radius`;
+ ```double radius(String parameter)``` - method which calculates the radius of resources.resources.figures.triangle.circle using characteristic in dependence of parameter:
